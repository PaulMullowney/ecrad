...
REAL(KIND=JPRB) :: TAU_MAJOR(NG15), TAU_MAJOR1(NG15)

EQUIVALENCE (KA(1,1,1,1),ABSA(1,1))

!$ACC DECLARE CREATE(FRACREFA, KA, ABSA, KA_MN2, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
!$OMP DECLARE TARGET(FRACREFA, KA_MN2, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
