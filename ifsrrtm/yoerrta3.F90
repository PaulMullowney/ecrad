...
REAL(KIND=JPRB) :: TAU_MAJOR(NG3), TAU_MAJOR1(NG3)

EQUIVALENCE (KA(1,1,1,1),ABSA(1,1)),(KB(1,1,13,1),ABSB(1,1))

!$ACC DECLARE CREATE(FRACREFA, FRACREFB, KA_MN2O, KB_MN2O, KA, ABSA, KB, ABSB, &
!$ACC                SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
!$OMP DECLARE TARGET (FRACREFA, FRACREFB, KA_MN2O, KB_MN2O, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
