...
REAL(KIND=JPRB) :: TAU_MAJOR(NG12), TAU_MAJOR1(NG12)

EQUIVALENCE (KA(1,1,1,1),ABSA(1,1))

!$ACC DECLARE CREATE(FRACREFA, KA, ABSA, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
!$OMP DECLARE TARGET(FRACREFA, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
