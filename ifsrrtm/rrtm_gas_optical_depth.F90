...
CALL RRTM_TAUMOL9  (KIDIA,KFDIA,KLEV,POD,&
 & PTAUAERL,PFAC00,PFAC01,PFAC10,PFAC11,PFORFAC,PFORFRAC,KINDFOR,KJP,KJT,KJT1,PONEMINUS,&
...
CALL RRTM_TAUMOL13 (KIDIA,KFDIA,KLEV,POD,&
 & PTAUAERL,PFAC00,PFAC01,PFAC10,PFAC11,PFORFAC,PFORFRAC,KINDFOR,KJP,KJT,KJT1,PONEMINUS,&
...
CALL RRTM_TAUMOL15 (KIDIA,KFDIA,KLEV,POD,&
 ...
 & laytrop_min=laytrop_min,laytrop_max=laytrop_max)
CALL RRTM_TAUMOL16 (KIDIA,KFDIA,KLEV,POD,&
 & PTAUAERL,PFAC00,PFAC01,PFAC10,PFAC11,PFORFAC,PFORFRAC,KINDFOR,KJP,KJT,KJT1,PONEMINUS,&
...
! taumol writes POD(g,lev,col) directly; no ZTAU transpose.
!     -----------------------------------------------------------------
