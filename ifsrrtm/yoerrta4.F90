...
REAL(KIND=JPRB) :: TAU_MAJOR(NG4), TAU_MAJOR1(NG4)

EQUIVALENCE (KA(1,1,1,1),ABSA(1,1)),(KB(1,1,13,1),ABSB(1,1))

!$ACC DECLARE CREATE(FRACREFA, FRACREFB, KA, ABSA, KB, ABSB, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
!$OMP DECLARE TARGET (FRACREFA, FRACREFB, SELFREF, FORREF, TAU_MAJOR, TAU_MAJOR1)
