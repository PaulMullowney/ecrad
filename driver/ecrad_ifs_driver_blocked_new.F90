...
#endif
#ifdef HAVE_ROCTX
        roctx_ret = roctxRangePushA("ifs_copy_inputs_to_blocked_new"//c_null_char)
#endif  
...
#ifdef HAVE_ROCTX
        call roctxRangePop()
        call roctxMarkA("ifs_copy_inputs_to_blocked_new"//c_null_char)
...
#ifdef HAVE_ROCTX
        call roctxRangePop()
        call roctxMarkA("copy_from_device"//c_null_char)
        roctx_ret = roctxRangePushA("ifs_copy_inputs_from_blocked_new"//c_null_char)
#endif  
...
#ifdef HAVE_ROCTX
        call roctxRangePop()
        call roctxMarkA("ifs_copy_inputs_from_blocked_new"//c_null_char)
#endif  
