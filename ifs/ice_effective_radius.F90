...
CASE(1,2)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) PRIVATE(ZTEMPERATURE_C)
...
CASE(3)
  ...
  !$OMP TARGET ENTER DATA MAP(ALLOC:ZMIN_DIAMETER_UM)
  ...
  !$OMP& ZTEMPERATURE_C, ZAIWC, ZBIWC, ZDIAMETER_UM)
