...
contains
  ...
  subroutine solver_mcica_omp_lw(nlev,istartcol,iendcol, &
    ...
    !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) PRIVATE(od_cloud_new, od_total, ssa_total, g_total, scat_od, jcol, jg, jlev, i_cloud_top) FIRSTPRIVATE(istartcol, iendcol, ng, nlev) THREAD_LIMIT(512)
    do jcol = istartcol,iendcol
       do jg = 1, ng
