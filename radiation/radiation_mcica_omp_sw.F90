...
#include "radiation_delta_eddington.h"
  ...
  subroutine solver_mcica_omp_sw(nlev,istartcol,iendcol, &
    ...
    use radiation_flux, only           : flux_type, debug_dump_sw
...
#ifdef HAVE_ROCTX
    roctx_ret = roctxRangePushA("radiation::mcica_omp_sw"//c_null_char)
#endif
...
#ifdef HAVE_ROCTX
    call roctxRangePop()
    call roctxMarkA("radiation::radiation::mcica_omp_sw"//c_null_char)
#endif
